...
export default class Concat extends BasedBundler {
     ...
     * @param {string|string[]} Object.sourceFiles The source files. Relative from current working directory.
     ...
     * 
     * @param {string} destinationPath The destination path. Relative from current working directory.
    ...
    writeFile(destinationPath) {
        ...
        const destFullPath = path.resolve(CW_DIR, destinationPath, this._destinationFile);
